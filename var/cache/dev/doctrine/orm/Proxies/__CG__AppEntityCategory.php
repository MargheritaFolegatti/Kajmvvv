...
class Category extends \App\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'value', '' . "\0" . 'App\\Entity\\Category' . "\0" . 'projects'];
        }
     ...
     * {@inheritDoc}
     */
    public function addProject(\App\Entity\Project $project): static
    {
     ...
     * {@inheritDoc}
     */
    public function removeProject(\App\Entity\Project $project): static
    {
