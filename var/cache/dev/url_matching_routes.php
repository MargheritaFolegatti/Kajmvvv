...
return [
    ...
    [ // $staticRoutes
        ...
        '/gioielli' => [[['_route' => 'jewels', '_controller' => 'App\\Controller\\DefaultController::jewels'], null, null, null, false, false, null]],
        '/chi-siamo' => [[['_route' => 'who', '_controller' => 'App\\Controller\\DefaultController::who'], null, null, null, false, false, null]],
        '/contatti' => [[['_route' => 'contact', '_controller' => 'App\\Controller\\DefaultController::contact'], null, null, null, false, false, null]],
        '/privacy-policy' => [[['_route' => 'privacy', '_controller' => 'App\\Controller\\DefaultController::privacy'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        21 => [[['_route' => 'homepage_with_section', '_controller' => 'App\\Controller\\DefaultController::indexWithSection'], ['section'], null, null, false, true, null]],
        ...
        119 => [[['_route' => '_profiler_font', '_controller' => 'web_profiler.controller.profiler::fontAction'], ['fontName'], null, null, false, false, null]],
